...
public class ButtonOpener33 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift17"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift18"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift17") && PlayerPrefs.HasKey("Gift18"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.3f && PlayerPrefs.HasKey("LevelComplete10"))
        {
