...
public class ButtonOpener43 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift23"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift24"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift23") && PlayerPrefs.HasKey("Gift24"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.3f && PlayerPrefs.HasKey("LevelComplete14"))
        {
