...
public class ButtonOpener51 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift25"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift26"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift25") && PlayerPrefs.HasKey("Gift26"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.8f && PlayerPrefs.HasKey("LevelComplete16"))
        {
