...
public class ButtonOpener53 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift29"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift30"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift29") && PlayerPrefs.HasKey("Gift30"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.3f && PlayerPrefs.HasKey("LevelComplete18"))
        {
