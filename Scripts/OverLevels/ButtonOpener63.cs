...
public class ButtonOpener63 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift35"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift36"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift35") && PlayerPrefs.HasKey("Gift36"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.3f && PlayerPrefs.HasKey("LevelComplete22"))
        {
