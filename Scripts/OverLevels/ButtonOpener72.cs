...
public class ButtonOpener72 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift39"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift40"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift39") && PlayerPrefs.HasKey("Gift40"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.8f && PlayerPrefs.HasKey("LevelComplete25"))
        {
