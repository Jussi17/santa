...
public class ButtonOpener73 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift41"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift1.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift42"))
        {
            renderer.GetComponent<SpriteRenderer>().color = Color.yellow;
            gift2.enabled = true;
        }
        if (PlayerPrefs.HasKey("Gift41") && PlayerPrefs.HasKey("Gift42"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.3f && PlayerPrefs.HasKey("LevelComplete26"))
        {
