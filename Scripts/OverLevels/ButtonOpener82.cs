...
public class ButtonOpener82 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.HasKey("Gift45") && PlayerPrefs.HasKey("Gift46"))
        {
    ...
    {
        if (Panel != null && Time.timeSinceLevelLoad > 0.8f && PlayerPrefs.HasKey("LevelComplete29"))
        {
