...
public class Movement6 : MonoBehaviour
{
    ...
    void Update()
    {
        anim.SetBool("running", dirX > 0.01f && grounded && !isCannonPushing && !onSlopeRunning && !onSlopeRunningLeft || dirX < -0.01f && grounded && !isCannonPushing && !onSlopeRunning && !onSlopeRunningLeft);
